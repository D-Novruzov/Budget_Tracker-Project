...
})({"1c99y":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "db8c0897d82edf82";
"use strict";
...
},{}],"bChS5":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "transactionList", ()=>transactionList);
parcelHelpers.export(exports, "financeChart", ()=>financeChart);
parcelHelpers.export(exports, "state", ()=>state);
parcelHelpers.export(exports, "history", ()=>history);
var _helpers = require("./helpers");
var _config = require("./config");
var _financeChart = require("./financeChart");
"use strict";
...
const financeChart = document.getElementById("finances");
const state = {
    selectedCurrency: "USD"
};
const history = {
    transactionHistory: (0, _helpers.storageManager)("get", "transactionHistory") || [],
    totalIncome: (0, _helpers.storageManager)("get", "totalIncome") || [],
    totalExpense: (0, _helpers.storageManager)("get", "totalExpenses")
};
let curBalance;
if ((0, _helpers.storageManager)("get", "currentBal") === null) {
    curBalance = 0;
    (0, _helpers.storageManager)("set", "currentBal", curBalance);
} else curBalance = (0, _helpers.parser)("currentBal");
const historyElementCreator = async function(arr, insertEl) {
    ...
    for (const el of arr){
        ...
        const html = `<li class="transaction-item">
            <span class="transaction-emoji">\u{1F4B8}</span>
            <div class="transaction-details">
              <p class="transaction-type">${data}</p>
              <p class="transaction-desc">${desc}</p>
              <p class="transaction-date">${month}/${day}/${year}</p>
            </div>
            <span class="transaction-amount" style="color: ${data === "deposit" ? "green" : "red"};">${(0, _config.currencies)[state.selectedCurrency]}${price.toFixed(2)}</span>
          </li>`;
...
document.addEventListener("DOMContentLoaded", async function() {
    ...
    const totalIncome = (0, _helpers.parser)("totalIncome");
    income.textContent = `$${totalIncome.toFixed(2)}`;
    const totalExpense = (0, _helpers.parser)("totalExpenses");
    expense.textContent = `$${totalExpense.toFixed(2)}`;
    (0, _financeChart.chartMaker)();
});
...
addBalanceForm.addEventListener("submit", function(e) {
    ...
    const deposit = {
        amount: parseFloat(balanceValue.value),
        date: date
    };
    ...
    balance.textContent = (0, _helpers.contentChanger)(curBalance);
    (0, _helpers.storageManager)("set", "currentBal", curBalance);
    const storedBalance = (0, _helpers.parser)("totalIncome");
    const updatedBalance = storedBalance + deposit.amount;
    income.textContent = (0, _helpers.contentChanger)(updatedBalance);
    (0, _helpers.storageManager)("set", "totalIncome", updatedBalance);
    history.transactionHistory.push(deposit);
    (0, _helpers.storageManager)("set", "transactionHistory", history.transactionHistory);
    addBalanceForm.classList.toggle("hidden");
    balanceValue.value = "";
});
...
transactionForm.addEventListener("submit", function(e) {
    ...
    let totalExpenses = (0, _helpers.parser)("totalExpenses");
    totalExpenses += amount;
    (0, _helpers.storageManager)("set", "totalExpenses", totalExpenses);
    expense.textContent = (0, _helpers.contentChanger)(totalExpenses);
    ///updating the current balance
    let updatedCurrentBalance = (0, _helpers.parser)("currentBal");
    updatedCurrentBalance -= amount;
    balance.textContent = (0, _helpers.contentChanger)(updatedCurrentBalance);
    (0, _helpers.storageManager)("set", "currentBal", updatedCurrentBalance);
    //emptying the values
...
currencyBox.addEventListener("change", async function() {
    try {
        ...
        const rateData = await (0, _helpers.fetchAPI)("USD", state.selectedCurrency, 1);
        rate = rateData.result;
        if (!rate || isNaN(rate)) throw new Error("Invalid rate received");
        const totalIncome = (0, _helpers.parser)("totalIncome");
        const totalExpense = (0, _helpers.parser)("totalExpenses");
        const currentBalance = (0, _helpers.parser)("currentBal");
        // Update the displayed values with proper currency symbols
        income.textContent = `${(0, _config.currencies)[state.selectedCurrency]}${(totalIncome * rate).toFixed(2)}`;
        expense.textContent = `${(0, _config.currencies)[state.selectedCurrency]}${(totalExpense * rate).toFixed(2)}`;
        balance.textContent = `${(0, _config.currencies)[state.selectedCurrency]}${(currentBalance * rate).toFixed(2)}`;
...
filtercheckButns.forEach((btn)=>{
    btn.addEventListener("change", ()=>{
        ...
        let filtered = [];
        if (value === "all") filtered = history.transactionHistory;
        else {
            let fromDate = new Date();
            if (value === "lastWeek") fromDate.setDate(today.getDate() - 7);
            else if (value === "lastMonth") fromDate.setMonth(today.getMonth() - 1);
...
},{"./config":"1thG1","./helpers":"hmWIg","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","./financeChart":"9U7jZ"}],"1thG1":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "API", ()=>API);
parcelHelpers.export(exports, "currencies", ()=>currencies);
const API = `https://api.exchangerate.host/convert?access_key=1c7a0858a14967a183acf899b77cf699`;
const apiKey = "1c7a0858a14967a183acf899b77cf699";
const currencies = {
    EUR: "\u20AC",
    USD: "$",
    JPY: "\xa5",
...
},{}],"hmWIg":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "storageManager", ()=>storageManager);
parcelHelpers.export(exports, "clearStorage", ()=>clearStorage);
parcelHelpers.export(exports, "fetchAPI", ()=>fetchAPI);
parcelHelpers.export(exports, "parser", ()=>parser);
parcelHelpers.export(exports, "contentChanger", ()=>contentChanger);
var _config = require("./config");
var _script = require("./script");
const storageManager = function(action, key, value) {
    if (action === "set") //in order to store the thingsd properly in hte local storage we need to stringify them
    window.localStorage.setItem(key, JSON.stringify(value));
    else //inorder to get them wwe need to parse aas it is string
    return JSON.parse(window.localStorage.getItem(key));
};
const clearStorage = function() {
    window.localStorage.clear();
};
const fetchAPI = async function(base, to, amount) {
    try {
        const response = await fetch(`${(0, _config.API)}&from=${base}&to=${to}&amount=${amount}`);
        if (!response.ok) throw new Error("Network response was not ok");
        const data = await response.json();
        if (!data.success) throw new Error(data.error?.info || "API returned an error");
        return data;
    } catch (err) {
...
const parser = function(key) {
    return parseFloat(storageManager("get", key)) || 0;
};
const contentChanger = function(name) {
    return `${(0, _config.currencies)[(0, _script.state).selectedCurrency]}${name.toFixed(2)}`;
}; //transaction history element templete
 //

},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","./config":"1thG1","./script":"bChS5"}],"9U7jZ":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "chartMaker", ()=>chartMaker);
var _script = require("./script");
var _auto = require("chart.js/auto");
const chartMaker = async function() {
    const data = {
        labels: [
            "Expenses",
            "Income"
        ...
        datasets: [
            {
                ...
                data: [
                    (0, _script.history).totalExpense,
                    (0, _script.history).totalIncome
                ],
                backgroundColor: [
                    "rgb(255, 99, 132)",
                    "rgb(0, 255, 0)"
    ...
    new (0, _auto.Chart)((0, _script.financeChart), {
        type: "doughnut",
        data: data,
        options: {
            responsive: true,
...
},{"./script":"bChS5","chart.js/auto":"a3bOj","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"a3bOj":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}]},["1c99y","bChS5"], "bChS5", "parcelRequire56ab", {})

//# sourceMappingURL=budget-trecker.d82edf82.js.map
